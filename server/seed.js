...
seed: (req, res) => {
    sequelize.query(`
        ...
        ('Faith', 8, 'Classic'),
        ('Here Comes The Sun', 8, 'Classic'),
        ('Come Together', 8, 'Classic'),
        ('Let It Be', 8, 'Classic'),
        ('Yesterday', 8, 'Classic'),
        ('Hey Jude', 7, 'Classic'),
        ...
        ('Lost', 12, 'R&B'),
        ('Pink + White', 12, 'R&B'),
        ('White Ferrari', 12, 'R&B'),
        ('Forrest Gump', 12, 'R&B'),
        ('Pink Matter', 12, 'R&B'),
        ('Remember Me', 13, 'R&B'),
        ('Lullaby', 13, 'R&B'),
        ('Runnin\'\'', 13, 'R&B'),
        ('Down to Earth', 13, 'R&B'),
        ('This Universe', 13, 'R&B'),
        ('Concrete', 14, 'R&B'),
        ('dirty dancer', 14, 'R&B'),
        ('Ne Me Quitte Pas', 14, 'R&B'),
        ('Antidote', 14, 'R&B'),
        ('Space Jame', 14, 'R&B'),
        ('Easy On Me', 15, 'R&B'),
        ('Set Fire To The Rain', 15, 'R&B'),
        ('River Lea', 15, 'R&B'),
        ('Water Under The Bridge', 15, 'R&B'),
        ('Sweetest Devotion', 15, 'R&B'),
        ('Heartless', 16, 'Rap'),
        ('Stronger', 16, 'Rap'),
